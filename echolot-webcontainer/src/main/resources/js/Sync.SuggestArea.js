 ...
 * @version 1.0
 */
exxcellent.SuggestArea = Core.extend(Echo.TextComponent, {

    $load: function () {
        Echo.ComponentFactory.registerType("exxcellent.SuggestArea", this);
    },
    ...
    componentType: "exxcellent.SuggestArea",

    doTriggerServerFilter: function (inputData) {
        this.fireEvent({
            type: exxcellent.SuggestArea.TRIGGER_SERVER_FILTER,
            source: this,
            data: inputData
        });
    },
    ...
    doFireSuggestItemSelected: function (inputData) {
        this.fireEvent({
            type: exxcellent.SuggestArea.SUGGEST_ITEM_SELECTED,
            source: this,
            data: inputData
        });
    }
...
/**
 * Sync.SuggestArea
 * Synchronisation component for Sync.SuggestArea.js
 *
 * Makes use of an extended jQuerUI autocomplete PlugIn jQuery.ui.autocomplete
 * @author Ralf Enderle <r.enderle@exxcellent.de>
 * @version 1.0
 */
exxcellent.SuggestAreaSync = Core.extend(Echo.Sync.TextComponent, {

    $load: function () {
        Echo.Render.registerPeer("exxcellent.SuggestArea", this);
    },
    ...
    renderUpdate: function (update) {
        var id = this.input;
        if (update.getUpdatedProperty(exxcellent.SuggestArea.SUGGEST_MODEL)) {
    ...
    _getUserDefinedStyle: function () {
        var style = {
            magnifier_img: Echo.Sync.ImageReference.getUrl(this.component.render(exxcellent.SuggestArea.MAGNIFIER_IMG)),
            loading_img: Echo.Sync.ImageReference.getUrl(this.component.render(exxcellent.SuggestArea.LOADING_IMG)),
            suggestFont: this.component.render(exxcellent.SuggestArea.SUGGEST_FONT),
            suggestForeground: this.component.render(exxcellent.SuggestArea.SUGGEST_FOREGROUND),
            descriptionFont: this.component.render(exxcellent.SuggestArea.DESCRIPTION_FONT),
            descriptionForeground: this.component.render(exxcellent.SuggestArea.DESCRIPTION_FOREGROUND),
            suggestAreaColor: this.component.render(exxcellent.SuggestArea.SUGGEST_AREA_COLOR),
            suggestAreaHover: this.component.render(exxcellent.SuggestArea.SUGGEST_AREA_HOVER)
        };
...
//        this._storeSelection();
    ...
    _getSuggestConfig: function () {
        ...
        suggestConfig.minLength = this.component.render(exxcellent.SuggestArea.MIN_LENGTH) || 1;
        suggestConfig.delay = this.component.render(exxcellent.SuggestArea.DELAY) || 300;
        suggestConfig.disabled = this.component.render(exxcellent.SuggestArea.DISABLED) || false;
        suggestConfig.doServerFilter = this.component.render(exxcellent.SuggestArea.DO_SERVER_FILTER) || false;
        suggestConfig.showDescription = this.component.render(exxcellent.SuggestArea.SHOW_DESCRIPTION) || false;
        suggestConfig.showCategory = this.component.render(exxcellent.SuggestArea.SHOW_CATEGORY) || false;
        suggestConfig.growLeft = this.component.render(exxcellent.SuggestArea.GROW_LEFT) || false;
    ...
    _getSuggestModel: function () {
        var value = this.component.render(exxcellent.SuggestArea.SUGGEST_MODEL);
