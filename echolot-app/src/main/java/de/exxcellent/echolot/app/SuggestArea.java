/*
 * This file (SuggestArea.java) is part of the Echolot Project (hereinafter "Echolot").
...
/**
 * Echo-Serverside component for the SuggestArea
 *
 * @author Ralf Enderle
 * @version 1.0
 */
public class SuggestArea extends TextComponent {
    ...
    /**
     * Removes a {@link de.exxcellent.echolot.listener.ServerFilterListener}
     *
    ...
    /**
     * ActionHandler to trigger all {@link de.exxcellent.echolot.listener.ServerFilterListener}
     *
     * @param inputValue
     */
    ...
    /**
     * Removes a {@link de.exxcellent.echolot.listener.SuggestItemSelectListener}
     *
     * @param l will be removed from listener list.
     */
    ...
    /**
     * ActionHandler to trigger all {@link de.exxcellent.echolot.listener.SuggestItemSelectListener}
     *
     * @param inputValue
     */
